		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#makereservation">Make a Reservation</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">This is the webpage for reservating rooms from our new hotel. 
					The hotel contains 40 rooms to reserve. In order to find an unreserved room please check the system. 
					If you want to delete your reservation please remove your reservation from our webpage.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">If you have any problem due to technical issues please contact us from the contact section. </p>
				</div>
			</div>
...
<section class="page-section" id="makereservation">
    <div class="container">
        ...
        <h2 class="page-section-heading text-center text-uppercase text-white">Make a Reservation</h2>
